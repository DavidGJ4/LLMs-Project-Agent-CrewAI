...
class CrewAISimulationAgent(SimulationAgent):
    ...
    def __init__(self, agents_config_path: str | None = None, llm: Any = None) -> None:
        self.agents_config_path = agents_config_path or os.environ.get("OPENEVOLVE_AGENTS_YAML")
        super().__init__(llm)

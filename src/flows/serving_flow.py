...
from src.utils.agents_yaml_io import load_agents_yaml
...
class AgentSocietyServingFlow(Flow[InferenceState]):
    def __init__(self, agents_config_path: str | None = None, *args, **kwargs):
        # CrewAI Flow is Pydantic-backed; set custom attrs after super().__init__.
    ...
    def trigger_crew_inference(self) -> dict:
        ...
        if self.agents_config_path:
            crew_instance.agents_config = load_agents_yaml(self.agents_config_path)
